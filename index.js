...
function portfolioItemDetails(portfolioItem) {
    ...
    document.querySelector(".pp__thumbnail a").href = portfolioItem.querySelector(".work__site").href;
...
async function sendMail(e) {
    ...
    try {
        ...
        if (name.value || email.value || message.value || phone.value ) {
            ...
            await emailjs.sendForm('service_2b2dv69', 'template_jrxnf6h', parentNode, 'user_cHmfISm7sED5Rr2y3J6Uv');
            alert("Message Sent");
            parentNode[0].value = '';
            parentNode[1].value = '';
            parentNode[2].value = '';
